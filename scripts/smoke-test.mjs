...
const checks = [
  ["/", ["构建，运行，迭代", "你现在想完成什么？", "你现在遇到了什么问题？", "先计算，再改代码", "Creep 身体计算器", "按你的阶段学习", "每一个结论，都有自己的证据等级", "最近发生了什么", "快速查询"]],
  ...
  ["/en/blog/screeps-creep-harvest-energy", ["How to Harvest Energy With Your First Creep", "Official engine source", "Screeps Console test", "Pending"]],
