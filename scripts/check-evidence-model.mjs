...
try {
  ...
  expect(registry.records.length === 80, `Content Identity registry must own 80 current Chinese articles, found ${registry.records.length}`);
} catch (error) {
...
console.log("- 80 current Chinese articles resolve to permanent Content Identity ownership.");
