  ...
  return (
    <main className={styles.home}>
      ...
      <section className={styles.quickSection} aria-labelledby="home-quick-title">
        <Container>
          <div className={styles.sectionHeading}>
            <div><p className="eyebrow">QUICK LOOKUP</p><h2 id="home-quick-title">快速查询与工具</h2></div>
            <Link href="/knowledge#reference-tools">查看全部入口 →</Link>
          </div>
      ...
      <section className={styles.latestSection} aria-labelledby="home-latest-title">
        <Container>
          <div className={styles.sectionHeading}>
            <div><p className="eyebrow">LATEST ARTICLES</p><h2 id="home-latest-title">最近发布</h2></div>
