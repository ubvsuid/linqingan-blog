...
export const metadata = createEnglishPageMetadata({
  ...
  description:
    "Learn Screeps with observable JavaScript examples, return-code debugging workflows, clearly stated test boundaries, and free tools for creeps, rooms, Market, Controllers, Labs, CPU, and automation.",
  path: "/en",
  chinesePath: "/",
});
...
const quickEntries = [
  ...
  { href: "/en/tools/market-terminal-cost-calculator", eyebrow: "MARKET TOOL", title: "Compare Market and Terminal costs", description: "Calculate transaction Energy, effective deal price, maximum Energy payload, and order fees." },
  { href: "/en/tools/lab-reaction-boost-planner", eyebrow: "LAB TOOL", title: "Plan reactions and Boost batches", description: "Expand compound chains and calculate base minerals, Lab runs, cooldown time, and Boost requirements." },
];
    ...
    <main className={styles.home} lang="en">
      <section className={`${styles.hero} screeps-room-grid`}>
        <Container className={styles.heroInner}>
          ...
          <p className={styles.heroStats}>{publishedEnglishArticles.length} published English guides · 8 knowledge modules · 5 working tools</p>
        ...
        <Container>
          <section className="english-task-hub" aria-labelledby="english-task-title">
            ...
            <div className="english-task-grid">
              ...
              <article><span>03</span><p className="eyebrow">USE A TOOL</p><h3>Calculate or diagnose before changing code</h3><p>Use local body, room, Market, Controller, and Lab tools without connecting a Screeps account.</p><Link href="/en/tools">Browse English tools →</Link></article>
            </div>
          </section>
        ...
        <Container>
          ...
          <div className={styles.learningGrid}>
            <article className={styles.learningIntro}>
              ...
              <div className={styles.statRow} aria-label="English section status"><div><strong>{publishedEnglishArticles.length}</strong><span>published guides</span></div><div><strong>5</strong><span>working tools</span></div><div><strong>8</strong><span>knowledge modules</span></div></div>
            </article>
            <ol className={styles.stageList}>
              ...
              <li><span>03</span><div><strong>Practical tools</strong><p>Body, room, Market, Controller, and Lab planning tools with explicit calculation boundaries.</p></div></li>
