...
export const metadata = createEnglishPageMetadata({
  ...
  description:
    "Learn Screeps with observable JavaScript examples, return-code debugging workflows, clearly stated test boundaries, and free tools for Creeps, rooms, Market, Controllers, Labs, Spawn queues, hauling, Towers, CPU, and automation.",
  path: "/en",
  chinesePath: "/",
});
...
const quickEntries = [
  ...
  { href: "/en/tools/spawn-queue-replacement-planner", eyebrow: "SPAWN TOOL", title: "Plan role replacement capacity", description: "Estimate Spawn utilization, prespawn TTL thresholds, and replacement load for several roles." },
  { href: "/en/tools/hauling-throughput-planner", eyebrow: "LOGISTICS TOOL", title: "Size a hauling route", description: "Calculate payload, fatigue speed, round-trip time, Creep count, and lifetime delivery." },
];
        ...
        <Container>
          ...
          <div className={styles.learningGrid}>
            <article className={styles.learningIntro}>
              ...
              <div className={styles.statRow} aria-label="English section status"><div><strong>{publishedEnglishArticles.length}</strong><span>published guides</span></div><div><strong>8</strong><span>working tools</span></div><div><strong>8</strong><span>knowledge modules</span></div></div>
            </article>
            <ol className={styles.stageList}>
              ...
              <li><span>03</span><div><strong>Practical tools</strong><p>Body, room, Market, Controller, Lab, Spawn, hauling, and Tower tools with explicit calculation boundaries.</p></div></li>
