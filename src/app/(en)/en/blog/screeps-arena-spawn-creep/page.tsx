...
import { englishArenaSpawnCreepArticle as article } from "@/lib/english-arena-spawn-creep-original-22";
...
const jsonLd = [
  {
    ...
    articleSection: discovery?.moduleTitle ?? "Spawn Lifecycle",
  },
  {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
...
export default function ScreepsArenaSpawnCreepPage() {
  return (
