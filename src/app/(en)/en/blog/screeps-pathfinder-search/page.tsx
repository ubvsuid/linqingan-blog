...
import { englishPathfinderSearchArticle as article } from "@/lib/english-pathfinder-original-19";
...
const jsonLd = [
  {
    ...
    articleSection: discovery?.moduleTitle ?? "Movement & Pathfinding",
  },
  {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
...
export default function ScreepsPathfinderSearchPage() {
  return (
