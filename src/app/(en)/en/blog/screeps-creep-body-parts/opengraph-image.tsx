...
export const alt = "Why Your Screeps Creep Cannot Harvest, Carry, or Move";

export default function CreepBodyPartsOpenGraphImage() {
  const labels = ["Beginner", "Lesson", "10 min read"];
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", maxWidth: 1000 }}>
          <span style={{ color: "#9ca3ad", fontSize: 20, letterSpacing: 1.5, textTransform: "uppercase" }}>Spawn and Creep Lifecycle</span>
          <h1 style={{ margin: "20px 0 0", fontSize: 56, lineHeight: 1.08, letterSpacing: -2.5 }}>Why Your Screeps Creep Cannot Harvest, Carry, or Move</h1>
        </div>
