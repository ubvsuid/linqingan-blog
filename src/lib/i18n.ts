...
export const languageRoutePairs = {
  ...
  "/screeps-api/structure-link": "/en/screeps-api/structure-link",
  "/screeps-api/structure-tower": "/en/screeps-api/structure-tower",
  "/screeps-api/structure-terminal": "/en/screeps-api/structure-terminal",
  "/screeps-api/structure-lab": "/en/screeps-api/structure-lab",
  "/screeps-api/path-finder": "/en/screeps-api/path-finder",
  "/screeps-api/store": "/en/screeps-api/store",
  "/tools": "/en/tools",
