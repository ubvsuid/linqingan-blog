...
export const nowEntries: NowEntry[] = [
  {
    id: "2026-07-knowledge-and-site-maintenance",
    date: "2026-07-22",
    title: "完成知识库结构与网站维护机制升级",
    paragraphs: [
      "这一阶段把网站从文章集合进一步整理成可持续维护的知识站。除了建立 8 个独立知识模块，也同步处理了文章导航、动态统计、资料入口、页脚和中等宽度设备上的导航体验。",
      "接下来会减少重复的手工维护，把更多检查放进发布流程，并继续补充真实 Screeps 环境中的运行证据。",
    ],
    bullets: [
      "为 52 篇专题文章建立模块归属、学习顺序和前后文导航",
      "让首页、资料中心和关于页的数据随内容自动更新",
      "整理标签中心与站内搜索，让查询入口更容易使用",
      "明确区分文档核对、语法检查、离线模拟和真实主循环验证",
    ],
  },
  {
