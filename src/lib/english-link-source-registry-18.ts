...
export const englishLinkSourceBatchEighteenRegistry: EnglishArticleRecord[] = [
  ...
  },
  {
    ...
    searchIntent:
      "Safely mutate one owned Screeps market order with nullable account-bound room identity, conservative fee reserve planning, duplicate-request protection, and explicit next-tick evidence boundaries",
    status: "published",
    finalScore: 99,
    keywords: [
  ...
  },
  {
    ...
    description:
      "Treat ticksToDecay as the next decay pulse, reject unsafe path deadlines, preserve repair() results, explain the current-engine repair-before-decay boundary, and verify EVENT_REPAIR amount and Energy spent on the next tick.",
    publishedAt: "2026-08-06",
    publishedLabel: "August 6, 2026",
    readingTime: "19 min read",
    primaryKeyword: "Screeps Container decay",
    searchIntent:
      "Prevent a visible Container from being lost to decay by combining complete-path deadline bounds with safe repair submission and exact processed EVENT_REPAIR evidence",
    status: "published",
    finalScore: 99,
    keywords: [
