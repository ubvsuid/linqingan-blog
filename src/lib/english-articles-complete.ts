...
const articleRecordOverrides: Record<string, EnglishArticleRecordOverride> = {
  ...
  "/en/blog/screeps-first-room-code": {
    ...
    description: "Combine three fixed beginner roles in one small loop, submit one validated Spawn request, keep Energy phases stable, expose failure statuses, and verify accepted commands on later ticks.",
    readingTime: "14 min read",
    primaryKeyword: "Screeps first room code",
    searchIntent: "Combine the completed beginner actions into one bounded single-room teaching loop and verify each accepted command across later ticks",
    finalScore: 98,
    updatedAt: "2026-07-31",
    keywords: [
      "Screeps first room code",
      "Screeps beginner main loop",
      "Screeps Harvester Upgrader Builder",
      "Screeps fixed name Creep loop",
      "Screeps room code failure states",
    ],
  },
