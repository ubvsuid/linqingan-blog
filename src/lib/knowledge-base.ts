...
export const knowledgeBaseSections: readonly KnowledgeBaseSection[] = [
  {
    ...
    number: 1,
    title: "Memory 与代码工程",
    description: "保存跨 tick 状态、恢复对象引用、清理过期数据，并逐步理解模块拆分、自己的 segments、公开 Foreign Segment、跨 Shard 状态与全局缓存。",
    audience: "已经完成新手路线，准备从固定名称代码进入可维护结构，并开始交换大型或跨边界状态的玩家。",
    learningGoal: "理解哪些数据应该跨 tick、跨玩家公开或跨 Shard 保存，怎样安全恢复对象，以及如何把不断增长的主循环拆成清楚的代码模块。",
    stages: [
      ...
      { title: "高级存储与交换", description: "继续了解自己的 segments、其他玩家公开 Segment、InterShardMemory 与全局缓存的使用边界。", from: 5, to: 9 },
    ],
    slugs: [
