...
export const knowledgeBaseSections: readonly KnowledgeBaseSection[] = [
  ...
  },
  {
    ...
    description: "从创建、身体配置、房间 Energy 供能诊断和返回值排查，到续命、回收与房间断代恢复，管理 Creep 的完整生命周期。",
    audience: "已经会创建基础 Creep，希望减少重名、Energy 不足、Extension 未填满和房间断代问题的玩家。",
    learningGoal: "把单次 spawnCreep() 调用扩展为可诊断、可恢复的 Creep 创建、房间供能与生命周期管理流程。",
    stages: [
      { title: "创建、身体与供能", description: "先读懂创建返回码，再根据可用 Energy 生成身体，并诊断 Spawn 与 Extension 的供能缺口。", from: 0, to: 3 },
      { title: "续命与回收", description: "理解 renewCreep() 和 recycleCreep() 的适用边界。", from: 3, to: 5 },
