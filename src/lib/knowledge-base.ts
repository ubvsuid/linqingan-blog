...
export const knowledgeBaseSections: readonly KnowledgeBaseSection[] = [
  ...
  },
  {
    ...
    description: "从创建返回码、多个 Spawn 队列、出口方向、身体配置和房间 Energy 供能诊断，到提前替换、续命、回收与断代恢复，管理 Creep 的完整生命周期。",
    audience: "已经会创建基础 Creep，希望减少重名、多个 Spawn 抢占、共享 Energy 重复承诺、出口阻塞、Extension 未填满、换代空窗和房间断代问题的玩家。",
    learningGoal: "把单次 spawnCreep() 调用扩展为包含房间级队列、出口诊断、供能检查、提前交接和故障恢复的 Creep 生命周期管理流程。",
    stages: [
      { title: "创建、队列、出口、身体与供能", description: "先读懂创建返回码，建立多个 Spawn 共享队列，再处理出口方向、动态身体和 Spawn 与 Extension 的供能缺口。", from: 0, to: 5 },
    ...
    slugs: [
      ...
      "screeps-multiple-spawn-queue-coordinator",
