...
export const knowledgeBaseSections: readonly KnowledgeBaseSection[] = [
  ...
  },
  {
    ...
    description: "从创建、出口方向、身体配置、房间 Energy 供能诊断和提前替换，到续命、回收与断代恢复，管理 Creep 的完整生命周期。",
    audience: "已经会创建基础 Creep，希望减少重名、Spawn 出口阻塞、Energy 不足、Extension 未填满、换代空窗和房间断代问题的玩家。",
    learningGoal: "把单次 spawnCreep() 调用扩展为包含出口诊断、供能检查、提前交接和故障恢复的 Creep 生命周期管理流程。",
    stages: [
      { title: "创建、出口、身体与供能", description: "先读懂创建返回码和出口方向，再根据可用 Energy 生成身体，并诊断 Spawn 与 Extension 的供能缺口。", from: 0, to: 4 },
