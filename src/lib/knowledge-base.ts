...
export const knowledgeBaseSections: readonly KnowledgeBaseSection[] = [
  ...
  },
  {
    ...
    description: "从创建、身体配置、房间 Energy 供能诊断和提前替换，到续命、回收与断代恢复，管理 Creep 的完整生命周期。",
    audience: "已经会创建基础 Creep，希望减少重名、Energy 不足、Extension 未填满、换代空窗和房间断代问题的玩家。",
    learningGoal: "把单次 spawnCreep() 调用扩展为可诊断、可提前交接、可恢复的 Creep 创建、供能与生命周期管理流程。",
    stages: [
      { title: "创建、身体与供能", description: "先读懂创建返回码，再根据可用 Energy 生成身体，并诊断 Spawn 与 Extension 的供能缺口。", from: 0, to: 3 },
      { title: "提前替换、续命与回收", description: "在旧 Creep 死亡前安排替代者，再理解 renewCreep() 和 recycleCreep() 的适用边界。", from: 3, to: 6 },
      { title: "断代恢复", description: "最后处理房间没有工作 Creep 时的紧急恢复。", from: 6, to: 7 },
    ],
    slugs: [
