...
export const knowledgeModuleRegistry: readonly KnowledgeModuleConfig[] = [
  {
    ...
    stages: [
      { id: "state-basics", title: "状态基础", description: "先理解 Memory、死亡数据清理和工作状态切换。", legacyFrom: 0, legacyTo: 3 },
      { id: "objects-modules", title: "对象与模块", description: "学习通过 ID 恢复对象，并用 require 拆分代码。", legacyFrom: 3, legacyTo: 5 },
      { id: "advanced-storage-cache", title: "高级存储与缓存", description: "继续了解 segments、InterShardMemory、Foreign Segment 与全局缓存的使用边界。", legacyFrom: 5, legacyTo: 9 },
    ],
    legacySlugs: [
  ...
  },
  {
    ...
    articleSource: "legacy",
    stages: [
      { id: "store-container", title: "Store 与 Container 基础", description: "先区分已用、剩余、总容量及 0/null，再学习 Container 取能与腐化维修。", legacyFrom: 0, legacyTo: 3 },
      { id: "resource-recovery", title: "获取与回收资源", description: "继续处理掉落 Energy、Tombstone、Ruin 和多 Source 选择。", legacyFrom: 3, legacyTo: 6 },
      { id: "room-storage-transfer", title: "房间内储运", description: "理解 Storage 和 Link 在房间经济中的位置。", legacyFrom: 6, legacyTo: 8 },
      { id: "interroom-minerals", title: "跨房间与矿物", description: "最后学习 Terminal 发送和 Mineral 采集。", legacyFrom: 8, legacyTo: 10 },
    ],
    legacySlugs: [
  ...
  },
  {
    ...
    articleSource: "legacy",
    stages: [
      { id: "common-errors", title: "先解决常见错误", description: "先排查距离不足、moveTo 不移动和 ERR_NO_PATH。", legacyFrom: 0, legacyTo: 3 },
      { id: "path-costs", title: "理解路径与移动成本", description: "继续学习 CostMatrix、跨房间路线、距离 API 和 fatigue。", legacyFrom: 3, legacyTo: 7 },
      { id: "vision-visualization", title: "视野与可视化", description: "最后处理房间可见性、Observer 和 RoomVisual 调试。", legacyFrom: 7, legacyTo: 10 },
    ],
    legacySlugs: [
  ...
  },
  {
    ...
    articleSource: "legacy",
    stages: [
      { id: "construction-management", title: "工地与建筑管理", description: "先学习创建、查看、删除工地和拆除完整建筑。", legacyFrom: 0, legacyTo: 4 },
      { id: "tower-actions", title: "Tower 动作", description: "继续处理 Tower 的攻击、维修和治疗。", legacyFrom: 4, legacyTo: 7 },
      { id: "defense-structures", title: "防御建筑", description: "最后管理 Rampart、Wall 和 Nuker。", legacyFrom: 7, legacyTo: 10 },
    ],
    legacySlugs: [
  ...
  },
  {
    ...
    articleSource: "legacy",
    stages: [
      { id: "market-operations", title: "市场操作", description: "先学习即时成交、创建订单，再安全执行改价、扩量和取消。", legacyFrom: 0, legacyTo: 3 },
      { id: "lab-boost", title: "Lab 与 Boost", description: "继续理解反应与强化 Creep 的基本流程。", legacyFrom: 3, legacyTo: 5 },
      { id: "production-power", title: "生产与 Power", description: "最后进入 Factory 和 Power Spawn。", legacyFrom: 5, legacyTo: 7 },
    ],
    legacySlugs: [
      "screeps-market-deal",
