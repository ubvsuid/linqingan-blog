...
export const knowledgeModuleRegistry: readonly KnowledgeModuleConfig[] = [
  ...
  },
  {
    ...
    number: 6,
    title: "建设与防御",
    description: "管理 Construction Site、建筑拆除、Tower 动作、Creep 近战、Rampart 通行、墙体维修和高等级防御建筑。",
    audience: "已经能建造基础建筑，准备管理工地生命周期、基础战斗、Tower 和防御建筑的玩家。",
    learningGoal: "把放置工地、跟踪进度、清理错误建筑、Creep 近战和防御动作整理成可检查的房间建设与防御流程。",
    articleSource: "metadata",
    stages: [
      ...
      { id: "creep-combat", title: "Creep 近战", description: "理解 Creep.attack() 的距离、ATTACK 部件、返回码和近战特殊行为。" },
      { id: "defense-structures", title: "防御建筑", description: "最后管理 Rampart、Wall 和 Nuker。" },
    ],
    systemMap: {
      zhTitle: "建设到防御的结构与战斗链",
      enTitle: "Construction and defense chain",
      zhDescription: "先完成房间结构，再用 Creep、Tower、Rampart 和 repair 共同维持房间安全。",
      enDescription: "Finish the room's structures first, then combine Creeps, Towers, Ramparts, and repair policies to keep it safe.",
      steps: [
        ...
        step("Creep / Tower", "Creep / Tower", "执行主动防御动作", "Execute active defense actions"),
        step("Rampart / repair", "Rampart / repair", "持续维护房间防线", "Maintain the room's defensive line"),
      ],
    },
  },
  {
