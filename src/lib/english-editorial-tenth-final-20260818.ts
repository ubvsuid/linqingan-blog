...
import { applyEnglishEditorialTwelfth20260818 } from "@/lib/english-editorial-twelfth-20260818";
import { applyEnglishEditorialTwelfthFinal20260818 } from "@/lib/english-editorial-twelfth-final-20260818";
...
export function applyEnglishEditorialTenthFinal20260818(
  ...
  const twelfthArticle = applyEnglishEditorialTwelfth20260818(eleventhArticle);
  return applyEnglishEditorialTwelfthFinal20260818(twelfthArticle);
}
